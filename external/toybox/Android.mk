...
trustme_cflags := -D__TRUSTME_NATIVE
...
LOCAL_CFLAGS += -DTOYBOX_VERSION='"$(toybox_version)"' $(trustme_cflags)
...
LOCAL_POST_INSTALL_CMD := $(hide) $(foreach t,$(ALL_TOOLS),ln -sf toybox_static $(TARGET_ROOT_OUT_SBIN)/$(t);)
